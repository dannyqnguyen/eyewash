...
flags.DEFINE_integer("train_size", 197017, "The size of train images [np.inf]")
...
flags.DEFINE_string("dataset", "/home/nguyda/Documents/insight/Insight_Project_Framework/dcgan-completion.tensorflow/data/celeba_align/aligned/", "Dataset directory.")
